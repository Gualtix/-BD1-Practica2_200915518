...
SELECT HOSPITAL.nombre AS Nombre,HOSPITAL.dirección AS Direccion,Fallecidos FROM HOSPITAL;
...
siguiente manera: nombre de hospital, nombre del contacto físico,
